...
Niavarani, Z., et al. “Modeling adsorption of mobile organic compounds on activated carbon and biochar using machine learning”.
...
2. Enter the required input descriptors for the new compounds and adsorbents
3. Save the file
4. Run:
...
The script writes the predicted log Kd values back into the Excel file.
